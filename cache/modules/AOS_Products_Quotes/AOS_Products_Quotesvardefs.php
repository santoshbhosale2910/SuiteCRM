 ...
 $GLOBALS["dictionary"]["AOS_Products_Quotes"]=array (
  ...
  array (
    ...
    array (
      ...
      'vname' => 'LBL_CATEGORY_ID_AOS_PRODUCT_CATEGORIES_ID',
      'type' => 'id',
      'massupdate' => '0',
      'default' => NULL,
      'no_default' => false,
      ...
      'len' => '36',
      'size' => '20',
      'id' => 'AOS_Products_Quotesaos_product_categories_id_c',
      'custom_module' => 'AOS_Products_Quotes',
    ),
    'category_id_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Category Id',
      'required' => false,
      'source' => 'non-db',
      'name' => 'category_id_c',
      ...
      'quicksearch' => 'enabled',
      'studio' => 'visible',
      'id' => 'AOS_Products_Quotescategory_id_c',
      'custom_module' => 'AOS_Products_Quotes',
    ),
    'charge_model_id_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Charge Model Id',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'charge_model_id_c',
      'vname' => 'LBL_CHARGE_MODEL_ID',
      'type' => 'enum',
      'massupdate' => '0',
      'default' => NULL,
      'no_default' => false,
      ...
      'len' => 100,
      'size' => '20',
      'options' => 'chargemodel_list',
      'studio' => 'visible',
      'dependency' => false,
      'id' => 'AOS_Products_Quotescharge_model_id_c',
      'custom_module' => 'AOS_Products_Quotes',
    ),
    'charge_price_table_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Charge Price Table',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'charge_price_table_c',
      'vname' => 'LBL_CHARGE_PRICE_TABLE',
      'type' => 'text',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
      ...
      'rows' => '4',
      'cols' => '20',
      'id' => 'AOS_Products_Quotescharge_price_table_c',
      'custom_module' => 'AOS_Products_Quotes',
    ),
    'charge_type_id_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Charge Type Id',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'charge_type_id_c',
      'vname' => 'LBL_CHARGE_TYPE_ID',
      'type' => 'enum',
      'massupdate' => '0',
      'default' => NULL,
      'no_default' => false,
      ...
      'studio' => 'visible',
      'dependency' => false,
      'id' => 'AOS_Products_Quotescharge_type_id_c',
      'custom_module' => 'AOS_Products_Quotes',
    ),
    'uom_c' => 
    array (
