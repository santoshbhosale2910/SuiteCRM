...
function insertProductLine(tableid, groupid) {
  ...
  a.innerHTML = "<input type='hidden' name='product_product_qty[" + prodln + "]' id='product_product_qty" + prodln + "'  value='' title='' tabindex='116' onblur='Quantity_format2Number(" + prodln + ");calculateLine(" + prodln + ",\"product_\");' class='product_qty'>";
  ...
  c.colSpan = "2";
  c.innerHTML = "<input type='text' name='product_product_list_price[" + prodln + "]' id='product_product_list_price" + prodln + "' maxlength='50' value='' title='' tabindex='116' onblur='calculateLine(" + prodln + ",\"product_\");' /><input type='hidden' name='product_product_cost_price[" + prodln + "]' id='product_product_cost_price" + prodln + "' value=''  />";
  ...
  e.innerHTML = "<input type='text' name='product_product_unit_price[" + prodln + "]' id='product_product_unit_price" + prodln + "' maxlength='50' value='' title='' tabindex='116' readonly='readonly' onblur='calculateLine(" + prodln + ",\"product_\");' onblur='calculateLine(" + prodln + ",\"product_\");' />";
  e.innerHTML += "<input type='hidden' name='product_vat_amt[" + prodln + "]' id='product_vat_amt" + prodln + "' value='0' class='product_vat_amt_text' />";
  e.innerHTML += "<input type='hidden' name='product_product_discount[" + prodln + "]' id='product_product_discount" + prodln + "' value='0' title=''class='product_discount_text' /><input type='hidden' name='product_product_discount_amount[" + prodln + "]' id='product_product_discount_amount" + prodln + "' value='0'  />";
  e.innerHTML += "<input type='hidden' name='product_discount[" + prodln + "]' id='product_discount" + prodln + "' value='Percentage'/>";
  e.innerHTML += "<input type='hidden' name='product_vat[" + prodln + "]' id='product_vat" + prodln + "' value='0' </input>";
  e.colSpan = "2";
...
function insertCategoryProductLine(tableid, groupid, products) {
 ...
 /* var c = x.insertCell(1);
  ...
  var c = x.insertCell(1);
  c.colSpan = "2";
  c.innerHTML = "<b>"+products.charge_model_id_c+"</b><input type='hidden' name='product_charge_model_id_c[" + prodln + "]' id='product_charge_model_id_c" + prodln + "' value='"+products.charge_model_id_c+"'>";

  var d = x.insertCell(2);
  d.colSpan = "2";
  d.innerHTML = "<b>"+products.charge_type_id_c+"</b><input type='hidden' name='product_charge_type_id_c[" + prodln + "]' id='product_charge_type_id_c" + prodln + "' value='"+products.charge_type_id_c+"'>";
    ...
    $.ajax({
            ...
            success: function (response) {
                ...
                for (var i = 0; i < jsonData.length; i++) {
                     ...
                     //console.log(products.pricebook);
...
function insertGroup()
{
  ...
  if(enable_groups){
    ...
    header_cell.innerHTML=SUGAR.language.get(module_sugar_grp1, 'LBL_GROUP_NAME')+":&nbsp;&nbsp;<input name='group_name[]' id='"+ table.id +"name' maxlength='255'  title='' tabindex='120' type='text' class='group_name' value=''><input type='hidden' name='group_id[]' id='"+ table.id +"id' value=''><input type='hidden' name='group_group_number[]' id='"+ table.id +"group_number' value='"+groupn+"'><button title='" + SUGAR.language.get('app_strings', 'LBL_SELECT_BUTTON_TITLE') + "' accessKey='" + SUGAR.language.get('app_strings', 'LBL_SELECT_BUTTON_KEY') + "' type='button' tabindex='121' class='button product_category_button' id='"+ table.id +"catbtn' value='" + SUGAR.language.get('app_strings', 'LBL_SELECT_BUTTON_LABEL') + "' name='btnCategory' onclick='openProductCategoryPopup(" + groupn + ");'><span class=\"suitepicon suitepicon-action-select\"></span></button>";
...
function markLineDeleted(ln, key)
{
  ...
  console.log(key + 'group_number' + ln+'***'+document.getElementById(key + 'group_number' + ln).value);
