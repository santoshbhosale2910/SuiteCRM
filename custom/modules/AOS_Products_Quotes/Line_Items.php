    ...
    if($view == 'EditView'){
        ...
        while ($row = $focus->db->fetchByAssoc($result)) {
            ...
            if($enable_groups && ($group_id != $row['group_id'] || $i == 0)){
                ...
                $groupStart .= "<tr>";
                $groupStart .= "<td colspan='2' class='tabDetailViewDL' colspan='2' style='text-align: left;padding:2px;' scope='row'><b>".$mod_strings['LBL_GROUP_NAME'].":</b></td>";
                $groupStart .= "<td class='tabDetailViewDL' colspan='6' style='text-align: left;padding:2px;'><b>".$group_item->name."</b></td>";
                $groupStart .= "</tr>";
            ...
            if($line_item->product_id != '0' && $line_item->product_id != null){
                ...
                $product .= "<td class='tabDetailViewDF' style='text-align: left; padding:5px;background: #ffdfe0;'>".++$productCount."</td>";
                ...
                $product .= "<td class='tabDetailViewDF' colspan ='2' style='text-align: left; padding:5px;background: #ffdfe0;'>".$app_list_strings['chargemodel_list'][$line_item->charge_model_id_c]."</td>";
                //$product .= "<td class='tabDetailViewDF' style='text-align: right; padding:5px;'>".get_discount_string($line_item->discount, $line_item->product_discount, $params, $locale, $sep)."</td>";
                $product .= "<td class='tabDetailViewDF' style='text-align: left; padding:5px;background: #ffdfe0;'>".$app_list_strings['charge_type_id_list'][$line_item->charge_type_id_c]."</td>";
                //if($locale->getPrecision()){
                //    $product .= "<td class='tabDetailViewDF' style='text-align: right; padding:5px;'>".rtrim(rtrim(format_number($line_item->vat), '0'),$sep[1])."%</td>";
                //} else {
               //     $product .= "<td class='tabDetailViewDF' style='text-align: right; padding:5px;'>".format_number($line_item->vat)."%</td>";
                //}
                //$product .= "<td class='tabDetailViewDF' style='text-align: right; padding:5px;'>".currency_format_number($line_item->vat_amt,$params )."</td>";
                ...
                $chargePriceLineItem = '';
                //$arrPriceTable = htmlspecialchars_decode($priceTable);
                ...
                if($serviceCount == 0)
                {
                   ...
                   // $service .= "<td width='12%' class='dataLabel' style='text-align: right;padding:5px;' scope='row'>".$mod_strings['LBL_SERVICE_DISCOUNT']."</td>";
                    $service .= "<td width='12%' class='dataLabel' style='text-align: right;padding:5px;' scope='row'>".$mod_strings['LBL_SERVICE_PRICE']."</td>";
                   // $service .= "<td width='12%' class='dataLabel' style='text-align: right;padding:5px;' scope='row'>".$mod_strings['LBL_VAT']."</td>";
                   // $service .= "<td width='12%' class='dataLabel' style='text-align: right;padding:5px;' scope='row'>".$mod_strings['LBL_VAT_AMT']."</td>";
                ...
                //$service .= "<td class='tabDetailViewDF' style='text-align: right; padding:5px;'>".get_discount_string($line_item->discount, $line_item->product_discount, $params, $locale, $sep)."</td>";
                ...
                //$service .= "<td class='tabDetailViewDF' style='text-align: right; padding:5px;'>".rtrim(rtrim(format_number($line_item->vat), '0'), $sep[1])."%</td>";
                //$service .= "<td class='tabDetailViewDF' style='text-align: right; padding:5px;'>".currency_format_number($line_item->vat_amt,$params )."</td>";
...
function insertChargePriceLineDetail($chargePrice, $count, $productId) {
    ...
    $chargePriceLineItem .= '<div style="width:20%;float:left;">'.$chargePrice->starting_unit.'&nbsp;</div>';
    $chargePriceLineItem .= '<div style="width:20%;float:left;">'.$chargePrice->end_unit.'&nbsp;</div>';
    $chargePriceLineItem .= '<div style="width:20%;float:left;"><span class="listprice">'.$chargePrice->list_price.'</span></div>';
